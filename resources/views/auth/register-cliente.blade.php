            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('psicologo') ? ' has-error' : '' }}">
                            <label for="psicologo" class="col-md-4 control-label">Código do Psicologo</label>

                            <div class="col-md-6">
                                <input id="psicologo" type="number" class="form-control" name="psicologo"
                                min="1" value="{{ old('psicologo') }}" required>

                                @if ($errors->has('psicologo'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('psicologo') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
