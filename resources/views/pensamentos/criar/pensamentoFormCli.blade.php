                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label>
                                        Situação
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="1. Que situação real, fluxo de pensamentos, devaneios ou recordações levaram a emoção desagradável?">
                                ...
                                <div class="col-sm-6">
                                    <label>
                                        ...
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="1. Quais foram os pensamentos automáticos que passaram pela sua cabeça?&#x0a;2. Quanto você acredita em cada um deles (0 a 100%)?">
                                            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>
                                        </a>
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label>
                                        Emoções
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="1. Que emoção(ões) você sentiu?(tristeza/ansiedade/raiva/etc...)&#x0a;2. Quanto a intensidade dessa emoção? (0 a 100%)">
                                            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>
                                        </a>
                                    </label>
                                ...
                                <div class="col-sm-6">
                                    <label>
                                        Conclusão
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="1. Quais são suas respostas racionais aos pensamentos automáticos?&#x0a;2. Use as perguntas abaixo para compor uma resposta ao(s) pensamento(s) automático(s)&#x0a;3. Quanto você acredita em cada resposta (0 a 100%)?">
                                            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>
                                        </a>
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <label>
                                        Resultado
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="1. Quanto você acredita agora em cada pensamento automático (0 a 100%)?&#x0a;2. Que emoção(ões) você sente agora? Qual a intensidade (0 - 100%)?&#x0a;3. O que você fará (ou fez)?">
                                            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>
                                        </a>
                                    </label>
